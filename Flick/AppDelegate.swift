...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        nowPlayingNavigationController.navigationBar.titleTextAttributes = titleTextAttributes
        
        let nowPlayingViewController = nowPlayingNavigationController.topViewController as! MoviesViewController
        nowPlayingViewController.endpoint = "now_playing"
//        nowPlayingViewController.tabBarItem = UITabBarItem(tabBarSystemItem: .recents, tag: 1)
        ...
        topRatedNavigationController.navigationBar.titleTextAttributes = titleTextAttributes
